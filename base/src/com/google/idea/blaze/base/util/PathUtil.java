...
/**
 * Helper to fix path for canonical files on Mac Catalina platform
 *
 ...
 * file with path to "/Volumes/google/src/...". This path cannot pass many prefix checkers e.g.
 * {@link com.google.idea.blaze.google3.wizard.SrcfsConstants#SRCFS_HEAD_PATH}. And user cannot
 * modify such file after open it since they are considered as out of project files. Even though
 * updating {@link* com.google.idea.blaze.base.model.primitives.WorkspaceRoot#directory} can solve
 * this issue, it will lead to existed project tree changed and many potential issues. So a utils
 * class is provided to remove unexpected "/Volumes" on Mac Catalina. It will make sure srcfs paths
 * are kept the same for all platforms
 */
